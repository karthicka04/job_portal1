# Generated by Django 5.1 on 2024-08-25 03:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_package', models.CharField(max_length=100)),
                ('is_for_experienced', models.BooleanField(default=False)),
                ('is_registered', models.ManyToManyField(blank=True, to='jobs.customuser')),
            ],
        ),
    ]
